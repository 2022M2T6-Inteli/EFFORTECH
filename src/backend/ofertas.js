    ...
    .then((data) => {
        ...
        todosOsServicos.map(function(todosOsServicos){
            if (todosOsServicos.obra_id === id_obra){
                saida += '<div class="tipo_servico col-12"><p>' + `${todosOsServicos.tipo}` + ':</p><div class="descricao_pintura"><a>Lorem Ipsum Lorem Ipsum Lorem Ipsum </a></div><br><button class="btn">CANDIDATAR-SE</button></div><br><br>'
            }
        })
